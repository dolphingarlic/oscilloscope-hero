...
module top ;
	...
	wire [0:0] tmpOE__Strum_net;
	wire [0:0] tmpIO_0__Strum_net;
	wire [0:0] tmpINTERRUPT_0__Strum_net;
	electrical [0:0] tmpSIOVREF__Strum_net;

	cy_psoc3_pins_v1_10
		#(.id("c703dd78-8e0c-4273-ba5b-b4f54ea7c61e"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Strum
		 (.oe(tmpOE__Strum_net),
		  .y({1'b0}),
		  .fb({Net_117}),
		  .io({tmpIO_0__Strum_net[0:0]}),
		  .siovref(tmpSIOVREF__Strum_net),
		  .interrupt({tmpINTERRUPT_0__Strum_net[0:0]}),
		  .annotation({Net_19}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Strum_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Btn_5_net;
	wire [0:0] tmpFB_0__Btn_5_net;
	wire [0:0] tmpIO_0__Btn_5_net;
	wire [0:0] tmpINTERRUPT_0__Btn_5_net;
	electrical [0:0] tmpSIOVREF__Btn_5_net;

	cy_psoc3_pins_v1_10
		#(.id("cceeb602-68b6-4a01-8206-1010b95940f4"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam BLE_UART.HwTXEnSignal = 0;
    defparam BLE_UART.NumDataBits = 8;
    defparam BLE_UART.NumStopBits = 1;
    defparam BLE_UART.ParityType = 0;
    defparam BLE_UART.RXEnable = 0;
    defparam BLE_UART.TXEnable = 1;

    assign Net_77 = 1'h0;

	wire [0:0] tmpOE__BLE_Tx_net;
	wire [0:0] tmpFB_0__BLE_Tx_net;
	wire [0:0] tmpIO_0__BLE_Tx_net;
	wire [0:0] tmpINTERRUPT_0__BLE_Tx_net;
	electrical [0:0] tmpSIOVREF__BLE_Tx_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		BLE_Tx
		 (.oe(tmpOE__BLE_Tx_net),
		  .y({Net_49}),
		  .fb({tmpFB_0__BLE_Tx_net[0:0]}),
		  .io({tmpIO_0__BLE_Tx_net[0:0]}),
		  .siovref(tmpSIOVREF__BLE_Tx_net),
		  .interrupt({tmpINTERRUPT_0__BLE_Tx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLE_Tx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Debouncer_v1_0 Strum_Debouncer (
        .d(Net_117),
        .clock(Net_123),
        .q(Net_124),
        .neg(Net_125),
        .either(Net_126),
        .pos(Net_127));
    defparam Strum_Debouncer.EitherEdgeDetect = 0;
    defparam Strum_Debouncer.NegEdgeDetect = 0;
    defparam Strum_Debouncer.PosEdgeDetect = 1;
    defparam Strum_Debouncer.SignalWidth = 1;
