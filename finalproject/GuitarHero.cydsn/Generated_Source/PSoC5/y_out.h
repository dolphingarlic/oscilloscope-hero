...
void    y_out_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the y_out_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(y_out__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in y_out_SetInterruptMode() function.
     *  @{
     */
        #define y_out_INTR_NONE      (uint16)(0x0000u)
        #define y_out_INTR_RISING    (uint16)(0x0001u)
        #define y_out_INTR_FALLING   (uint16)(0x0002u)
        #define y_out_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define y_out_INTR_MASK      (0x01u) 
#endif /* (y_out__INTSTAT) */
...
/* SIO registers */
#if defined(y_out__SIO_CFG)
    #define y_out_SIO_HYST_EN        (* (reg8 *) y_out__SIO_HYST_EN)
    #define y_out_SIO_REG_HIFREQ     (* (reg8 *) y_out__SIO_REG_HIFREQ)
    #define y_out_SIO_CFG            (* (reg8 *) y_out__SIO_CFG)
    #define y_out_SIO_DIFF           (* (reg8 *) y_out__SIO_DIFF)
#endif /* (y_out__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define y_out_0_INTTYPE_REG 		(* (reg8 *) y_out__0__INTTYPE)
#endif /* (y_out__INTSTAT) */
