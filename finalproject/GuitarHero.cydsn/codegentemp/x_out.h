...
void    x_out_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the x_out_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(x_out__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in x_out_SetInterruptMode() function.
     *  @{
     */
        #define x_out_INTR_NONE      (uint16)(0x0000u)
        #define x_out_INTR_RISING    (uint16)(0x0001u)
        #define x_out_INTR_FALLING   (uint16)(0x0002u)
        #define x_out_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define x_out_INTR_MASK      (0x01u) 
#endif /* (x_out__INTSTAT) */
...
/* SIO registers */
#if defined(x_out__SIO_CFG)
    #define x_out_SIO_HYST_EN        (* (reg8 *) x_out__SIO_HYST_EN)
    #define x_out_SIO_REG_HIFREQ     (* (reg8 *) x_out__SIO_REG_HIFREQ)
    #define x_out_SIO_CFG            (* (reg8 *) x_out__SIO_CFG)
    #define x_out_SIO_DIFF           (* (reg8 *) x_out__SIO_DIFF)
#endif /* (x_out__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define x_out_0_INTTYPE_REG 		(* (reg8 *) x_out__0__INTTYPE)
#endif /* (x_out__INTSTAT) */
