...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=x_DAC, CY_INSTANCE_SHORT_NAME=x_DAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=x_DAC, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=y_DAC, CY_INSTANCE_SHORT_NAME=y_DAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=y_DAC, )
...
module CharLCD_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("81e5a43b-9817-4246-a0bf-0db5c5a0f9c7/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// emFile_v1_20(Max_SPI_Frequency=12000, NumberSDCards=1, WP0_En=false, WP1_En=false, WP2_En=false, WP3_En=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=emFile_v1_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SD_FS, CY_INSTANCE_SHORT_NAME=SD_FS, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=SD_FS, )
module emFile_v1_20_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a3c0aaa0-dc77-4bab-a158-5e63bc9c5c34/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("a3c0aaa0-dc77-4bab-a158-5e63bc9c5c34/5ed615c6-e1f0-40ed-8816-f906ef67d531"),
	...
	cy_psoc3_pins_v1_10
		#(.id("a3c0aaa0-dc77-4bab-a158-5e63bc9c5c34/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a3c0aaa0-dc77-4bab-a158-5e63bc9c5c34/ae249072-87dc-41aa-9405-888517aefa28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a3c0aaa0-dc77-4bab-a158-5e63bc9c5c34/6df85302-e45f-45fb-97de-4bdf3128e07b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Audio_DAC, CY_INSTANCE_SHORT_NAME=Audio_DAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Audio_DAC, )
...
module top ;
	...
	wire [0:0] tmpIO_0__x_out_net;
	wire [0:0] tmpINTERRUPT_0__x_out_net;
	electrical [0:0] tmpSIOVREF__x_out_net;
	...
	cy_psoc3_pins_v1_10
		...
		x_out
		 (.oe(tmpOE__x_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__x_out_net[0:0]}),
		  .analog({Net_4}),
		  .io({tmpIO_0__x_out_net[0:0]}),
		  .siovref(tmpSIOVREF__x_out_net),
		  .interrupt({tmpINTERRUPT_0__x_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__x_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_0 x_DAC (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_4));
    defparam x_DAC.Data_Source = 0;
    defparam x_DAC.Initial_Value = 100;
    defparam x_DAC.Strobe_Mode = 0;

	wire [0:0] tmpOE__y_out_net;
	wire [0:0] tmpFB_0__y_out_net;
	wire [0:0] tmpIO_0__y_out_net;
	wire [0:0] tmpINTERRUPT_0__y_out_net;
	electrical [0:0] tmpSIOVREF__y_out_net;

	cy_psoc3_pins_v1_10
		#(.id("1264b7bc-67ff-4244-9470-0c3df1031737"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		y_out
		 (.oe(tmpOE__y_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__y_out_net[0:0]}),
		  .analog({Net_9}),
		  .io({tmpIO_0__y_out_net[0:0]}),
		  .siovref(tmpSIOVREF__y_out_net),
		  .interrupt({tmpINTERRUPT_0__y_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__y_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_1 y_DAC (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_9));
    defparam y_DAC.Data_Source = 0;
    defparam y_DAC.Initial_Value = 100;
    ...
    UART_v2_50_2 BLE_UART (
        ...
        .reset(Net_238),
        .rx(Net_239),
        .tx_interrupt(Net_245),
        .rx_interrupt(Net_237),
        .tx_data(Net_246),
        .tx_clk(Net_247),
        .rx_data(Net_248),
        .rx_clk(Net_249));
    defparam BLE_UART.Address1 = 0;
    defparam BLE_UART.Address2 = 0;
    defparam BLE_UART.EnIntRXInterrupt = 0;
    defparam BLE_UART.EnIntTXInterrupt = 0;
    defparam BLE_UART.FlowControl = 0;
    defparam BLE_UART.HalfDuplexEn = 0;
    defparam BLE_UART.HwTXEnSignal = 1;
    defparam BLE_UART.NumDataBits = 8;
    defparam BLE_UART.NumStopBits = 1;
    defparam BLE_UART.ParityType = 0;
    defparam BLE_UART.RXEnable = 1;
    defparam BLE_UART.TXEnable = 0;

	wire [0:0] tmpOE__BLE_Rx_net;
	wire [0:0] tmpIO_0__BLE_Rx_net;
	wire [0:0] tmpINTERRUPT_0__BLE_Rx_net;
	electrical [0:0] tmpSIOVREF__BLE_Rx_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		BLE_Rx
		 (.oe(tmpOE__BLE_Rx_net),
		  .y({1'b0}),
		  .fb({Net_239}),
		  .io({tmpIO_0__BLE_Rx_net[0:0]}),
		  .siovref(tmpSIOVREF__BLE_Rx_net),
		  .interrupt({tmpINTERRUPT_0__BLE_Rx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLE_Rx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b2ad504c-6072-4943-9e55-b844be38c81b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    emFile_v1_20_5 SD_FS ();

    VDAC8_v1_90_6 Audio_DAC (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_226));
