...
*
*******************************************************************************/
void FPS_Clock_Start(void) 
{
    /* Set the bit to enable the clock. */
    FPS_Clock_CLKEN |= FPS_Clock_CLKEN_MASK;
	FPS_Clock_CLKSTBY |= FPS_Clock_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: FPS_Clock_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    FPS_Clock_CLKEN &= (uint8)(~FPS_Clock_CLKEN_MASK);
	FPS_Clock_CLKSTBY &= (uint8)(~FPS_Clock_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: FPS_Clock_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_StopBlock(void) 
{
    if ((FPS_Clock_CLKEN & FPS_Clock_CLKEN_MASK) != 0u)
    {
...
#if defined(FPS_Clock__CFG3)
        CLK_DIST_AMASK = FPS_Clock_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = FPS_Clock_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* FPS_Clock__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(FPS_Clock_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(FPS_Clock_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: FPS_Clock_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        FPS_Clock_CLKSTBY &= (uint8)(~FPS_Clock_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: FPS_Clock_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = FPS_Clock_GetSourceRegister();
    uint16 oldDivider = FPS_Clock_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = FPS_Clock_CLKEN & FPS_Clock_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((FPS_Clock_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: FPS_Clock_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 FPS_Clock_GetDividerRegister(void) 
{
    return CY_GET_REG16(FPS_Clock_DIV_PTR);
}


/*******************************************************************************
* Function Name: FPS_Clock_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_SetModeRegister(uint8 modeBitMask) 
{
    FPS_Clock_MOD_SRC |= modeBitMask & (uint8)FPS_Clock_MODE_MASK;
}


/*******************************************************************************
* Function Name: FPS_Clock_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_ClearModeRegister(uint8 modeBitMask) 
{
    FPS_Clock_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(FPS_Clock_MODE_MASK));
}


/*******************************************************************************
* Function Name: FPS_Clock_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 FPS_Clock_GetModeRegister(void) 
{
    return FPS_Clock_MOD_SRC & (uint8)(FPS_Clock_MODE_MASK);
}


/*******************************************************************************
* Function Name: FPS_Clock_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = FPS_Clock_GetDividerRegister();
    uint8 oldSrc = FPS_Clock_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        FPS_Clock_MOD_SRC |= CYCLK_SSS;
        FPS_Clock_MOD_SRC =
            (FPS_Clock_MOD_SRC & (uint8)(~FPS_Clock_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: FPS_Clock_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 FPS_Clock_GetSourceRegister(void) 
{
    return FPS_Clock_MOD_SRC & FPS_Clock_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: FPS_Clock_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void FPS_Clock_SetPhaseRegister(uint8 clkPhase) 
{
    FPS_Clock_PHASE = clkPhase & FPS_Clock_PHASE_MASK;
}


/*******************************************************************************
* Function Name: FPS_Clock_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 FPS_Clock_GetPhaseRegister(void) 
{
    return FPS_Clock_PHASE & FPS_Clock_PHASE_MASK;
}
